...
const Home = () => {
  const [inputText, setInputText] = useState<CreateNoteData>({
    title: "",
    description: "",
    date: "",
  });
  ...
  const user = JSON.parse(getLocalStorage("profile"));
  const updatedNote = useSelector((state: RootState) =>
